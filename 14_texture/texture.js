...
var Triangle = function (indexes, color, normals, texture, uvs) {
  if (!(this instanceof Triangle)) {
    return new Triangle(indexes, color, normals, texture, uvs);
  }
...
var Model = function (vertexes, triangles, bounds_center, bounds_radius) {
  if (!(this instanceof Model)) {
    return new Model(vertexes, triangles, bounds_center, bounds_radius);
  }
...
var CanvasToViewport = function (p2d) {
  return Pt((p2d.x * viewport_size) / canvas.width, (p2d.y * viewport_size) / canvas.height);
};
...
var RenderTriangle = function (triangle, vertexes, projected, camera, lights, orientation) {
  ...
  var normal = ComputeTriangleNormal(
    vertexes[triangle.indexes[0]],
    vertexes[triangle.indexes[1]],
    vertexes[triangle.indexes[2]]
  );
  ...
  var centre = Multiply(
    -1.0 / 3.0,
    Add(
      Add(vertexes[triangle.indexes[0]], vertexes[triangle.indexes[1]]),
      vertexes[triangle.indexes[2]]
    )
  );
  ...
  var [v0, v1, v2] = [
    vertexes[triangle.indexes[i0]],
    vertexes[triangle.indexes[i1]],
    vertexes[triangle.indexes[i2]],
  ];
...
var GenerateSphere = function (divs, color) {
  ...
  for (var d = 0; d < divs; d++) {
    for (var i = 0; i < divs; i++) {
      ...
      triangles.push(
        Triangle(tri0, color, [vertexes[tri0[0]], vertexes[tri0[1]], vertexes[tri0[2]]])
      );
      triangles.push(
        Triangle(tri1, color, [vertexes[tri1[0]], vertexes[tri1[1]], vertexes[tri1[2]]])
      );
    }
  }
...
var triangles = [
  Triangle([0, 1, 2], RED, [Vertex(0, 0, 1), Vertex(0, 0, 1), Vertex(0, 0, 1)], wood_texture, [
    Pt(0, 0),
    Pt(1, 0),
    Pt(1, 1),
  ]),
  Triangle([0, 2, 3], RED, [Vertex(0, 0, 1), Vertex(0, 0, 1), Vertex(0, 0, 1)], wood_texture, [
    Pt(0, 0),
    Pt(1, 1),
    Pt(0, 1),
  ]),
  Triangle([4, 0, 3], GREEN, [Vertex(1, 0, 0), Vertex(1, 0, 0), Vertex(1, 0, 0)], wood_texture, [
    Pt(0, 0),
    Pt(1, 0),
    Pt(1, 1),
  ]),
  Triangle([4, 3, 7], GREEN, [Vertex(1, 0, 0), Vertex(1, 0, 0), Vertex(1, 0, 0)], wood_texture, [
    Pt(0, 0),
    Pt(1, 1),
    Pt(0, 1),
  ]),
  Triangle([5, 4, 7], BLUE, [Vertex(0, 0, -1), Vertex(0, 0, -1), Vertex(0, 0, -1)], wood_texture, [
    Pt(0, 0),
    Pt(1, 0),
    Pt(1, 1),
  ]),
  Triangle([5, 7, 6], BLUE, [Vertex(0, 0, -1), Vertex(0, 0, -1), Vertex(0, 0, -1)], wood_texture, [
    Pt(0, 0),
    Pt(1, 1),
    Pt(0, 1),
  ]),
  Triangle(
    [1, 5, 6],
    YELLOW,
    [Vertex(-1, 0, 0), Vertex(-1, 0, 0), Vertex(-1, 0, 0)],
    wood_texture,
  ...
  Triangle([1, 0, 5], PURPLE, [Vertex(0, 1, 0), Vertex(0, 1, 0), Vertex(0, 1, 0)], wood_texture, [
    Pt(0, 0),
    Pt(1, 0),
    Pt(1, 1),
  ]),
  Triangle([5, 0, 4], PURPLE, [Vertex(0, 1, 0), Vertex(0, 1, 0), Vertex(0, 1, 0)], wood_texture, [
    Pt(0, 1),
    Pt(1, 1),
    Pt(0, 0),
  ]),
  Triangle([2, 6, 7], CYAN, [Vertex(0, -1, 0), Vertex(0, -1, 0), Vertex(0, -1, 0)], wood_texture, [
    Pt(0, 0),
    Pt(1, 0),
    Pt(1, 1),
  ]),
  Triangle([2, 7, 3], CYAN, [Vertex(0, -1, 0), Vertex(0, -1, 0), Vertex(0, -1, 0)], wood_texture, [
    Pt(0, 0),
    Pt(1, 1),
    Pt(0, 1),
  ]),
